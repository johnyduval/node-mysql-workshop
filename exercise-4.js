...
connection.query("select Account.id as account_id, Account.email as account_email, AddressBook.id as addressbook_id, AddressBook.name as addressbook_name from Account join AddressBook on Account.id = AddressBook.accountId", function(err, result) {
